...
function AppShell({ children }) {
  return (
    <div className="relative mx-auto min-h-screen w-full max-w-[560px] overflow-hidden px-3 pb-[calc(9.5rem+env(safe-area-inset-bottom))] pt-3 sm:px-4 sm:pt-4">
      <div className="app-shell-bg pointer-events-none absolute inset-0 -z-10" />
      <div className="app-shell-frame pointer-events-none absolute inset-x-1 bottom-24 top-2 -z-10 rounded-[30px] sm:inset-x-2" />
